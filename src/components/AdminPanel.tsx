    ...
    >
      ...
      >
              ...
              {localConfig.pages.map((page, idx) => (
                <div key={page.id} className="p-6 border rounded-xl space-y-6 bg-gray-50">
                  <div className="flex justify-between items-center">
                    <h3 className="font-bold text-lg">Page {idx + 1}: {page.title}</h3>
                  </div>
        ...
        <div className="p-6 border-t bg-gray-50 flex gap-4">
          ...
          <button 
            onClick={handleSave}
            className="flex-1 flex items-center justify-center gap-2 bg-black text-white px-6 py-3 rounded-lg hover:bg-gray-800 transition-colors font-bold shadow-lg"
          >
            <Save size={18} />
            Apply Changes
          </button>
